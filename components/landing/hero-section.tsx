        ...
        <div className="flex gap-16 marquee whitespace-nowrap">
          {[...Array(2)].map((_, i) => (
            <div key={i} className="flex gap-16">
              {[
                { value: "2M", label: "WebSocket connections on one node", company: "PHOENIX" },
                { value: "150→5", label: "servers for equivalent traffic", company: "BLEACHER REPORT" },
                { value: "$2M/yr", label: "infrastructure savings", company: "PINTEREST" },
                { value: "$150/mo", label: "down from $16k Lambda", company: "BEAM" },
              ].map((stat) => (
