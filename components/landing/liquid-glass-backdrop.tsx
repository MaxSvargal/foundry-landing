...
export function LiquidGlassBackdrop() {
  return (
    <div className="pointer-events-none absolute inset-0 z-[2] overflow-hidden">
      <div
        className="absolute inset-0 bg-white/97 supports-[backdrop-filter]:bg-white/58"
        style={{
          WebkitBackdropFilter: "blur(18px) saturate(1.2)",
          backdropFilter: "blur(18px) saturate(1.2)",
        }}
      />
      <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(255,255,255,0.95)_0%,rgba(255,255,255,0.7)_18%,rgba(255,255,255,0.5)_54%,rgba(255,255,255,0.76)_100%)]" />
      ...
      <div className="absolute inset-0 bg-[linear-gradient(135deg,rgba(255,255,255,0.48),transparent_24%,transparent_76%,rgba(255,255,255,0.18))]" />
      <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-white/98 to-transparent" />
